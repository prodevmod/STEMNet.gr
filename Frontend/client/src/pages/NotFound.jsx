        ...
        <>
            ...
            <main className="app-main-container">
                <div className="card" style={{ padding: '3rem 1.5rem', textAlign: 'center', maxWidth: '480px', margin: '2rem auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <h1 style={{ fontSize: '4.5rem', margin: '0 0 0.25rem 0', fontWeight: 800, lineHeight: 1 }}>404</h1>
                    <h2 style={{ marginTop: 0, marginBottom: '0.75rem' }}>Page Not Found</h2>
                    <p style={{ color: '#64748b', marginBottom: '1.75rem', maxWidth: '400px' }}>
                        The page or post you are looking for does not exist, may have been moved, or has a broken link.
                    </p>
                    <div>
